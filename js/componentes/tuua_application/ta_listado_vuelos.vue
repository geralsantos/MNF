    ...
    <div class="">
        ...
        <template v-if="false">
            <div id="frm_crear_manifiesto">
                <div class="fila"><span>Fecha Vuelo : </span><input type="text" id="fecha_vuelo"
                        v-model="CMfecha_vuelo.value" :disabled="CMfecha_vuelo.disabled" placeholder="Ejemplo " /></div>
                <div class="fila"><span>Nro Vuelo : </span><input type="text" id="nro_vuelo" v-model="CMnro_vuelo.value"
                        :disabled="CMnro_vuelo.disabled" placeholder="Ejemplo 230" /></div>
                <div class="fila"><span>Origen : </span><input type="text" id="origen" v-model="CMorigen.value"
                        :disabled="CMorigen.disabled" placeholder="Ejemplo LIM" /></div>
                <div class="fila"><span>C/P Itin : </span><input type="text" id="hora_despegue"
                        v-model="CMhora_despegue.value" :disabled="CMhora_despegue.disabled"
                        placeholder="Ejemplo 0600" /></div>
                <div class="fila"><span>C/P : </span><input type="text" id="hora_cierra_despegue"
                        v-model="CMhora_cierra_despegue.value" :disabled="CMhora_cierra_despegue.disabled"
                        placeholder="Ejemplo 0601" /></div>
                <div class="fila"><span>Arr - In : </span><input type="text" id="hora_llegada_destino"
                        v-model="CMhora_llegada_destino.value" :disabled="CMhora_llegada_destino.disabled"
                        placeholder="Ejemplo 0701" /></div>
                <div class="fila"><span>Matricula : </span><input type="text" id="matricula_avion"
                        v-model="CMmatricula_avion.value" :disabled="CMmatricula_avion.disabled"
                        placeholder="Ejemplo OB2079" /></div>
            </div>
        </template>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          ...
                          <input name="txtOrigen" class="form-control" placeholder="Origen" type="text" id="txtOrigen"
                ...
                <talistadovueloskiu v-if="showtalistadovueloskiu" :idFileTuuaUno="false" :fecha_ini="fecha_ini"
